...
<style>
    ...
    /* 顶部导航栏 - 贴顶 - 复刻 graph.html */
    .top-header {
        background: linear-gradient(135deg, #667eea, #764ba2);
        padding: 16px 32px; /* 复刻 graph.html 的 padding */
        width: 100%;
        display: flex;
    ...
    .top-header h1 {
        font-size: 20px; /* 复刻 graph.html 字体大小 */
        margin: 0;
    ...
    /* 为下方内容添加一些边距，避免贴边 */
    .stButton, .stTextInput, .stMarkdown:not(:first-child) {
        padding-left: 10px;
        padding-right: 10px;
    }
